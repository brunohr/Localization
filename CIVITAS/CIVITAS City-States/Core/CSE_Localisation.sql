...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_SCIENTIFIC_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 de [ICON_SCIENCE] Ciência em cada Biblioteca."					),
	("pt_BR",	"LOC_CSE_SCIENTIFIC_TRAIT_LARGE_INFLUENCE_BONUS",		"+2 de [ICON_SCIENCE] Ciência em cada Universidade."				),
	("pt_BR",	"LOC_CSE_SCIENTIFIC_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 de [ICON_SCIENCE] Ciência em cada Laboratório de Pesquisa."		),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_CULTURAL_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 de [ICON_CULTURE] Cultura em cada Anfiteatro."								),
	("pt_BR",	"LOC_CSE_CULTURAL_TRAIT_LARGE_INFLUENCE_BONUS",			"+2 de [ICON_CULTURE] Cultura em cada Museu de Arte ou Museu de Arqueologia."	),
	("pt_BR",	"LOC_CSE_CULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 de [ICON_CULTURE] Cultura em cada Centro de Transmissão."					),
