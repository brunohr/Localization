/*
	Localisation
	Authors: thecrazyscotsman, p0kiehl, SeelingCat, ChimpanG, cachaco
	
	cachaco: civilopedia not translated
*/
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_SCIENTIFIC_TRAIT_SMALL_INFLUENCE_BONUS",		"+2 de [ICON_SCIENCE] Ciência na sua [ICON_CAPITAL] Capital."		),
	("pt_BR",	"LOC_CSE_SCIENTIFIC_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 de [ICON_Ciência] Ciência em cada Biblioteca."					),
	("pt_BR",	"LOC_CSE_SCIENTIFIC_TRAIT_LARGE_INFLUENCE_BONUS",		"+2 de [ICON_Ciência] Ciência em cada Universidade."				),
	("pt_BR",	"LOC_CSE_SCIENTIFIC_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 de [ICON_Ciência] Ciência em cada Laboratório de Pesquisa."		),
	("pt_BR",	"LOC_CSE_SCIENTIFIC_TRAIT_NAME",						"{LOC_CITY_STATES_TYPE_SCIENTIFIC} Cidade-Estado"					),
...
-----------------------------------------------
	...
	("en_US",	"LOC_CSE_CULTURAL_TRAIT_SMALL_INFLUENCE_BONUS",			"+2 de [ICON_CULTURE] Cultura na sua [ICON_CAPITAL] Capital."					),
	("pt_BR",	"LOC_CSE_CULTURAL_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 de [ICON_Cultura] Cultura em cada Anfiteatro."								),
	("pt_BR",	"LOC_CSE_CULTURAL_TRAIT_LARGE_INFLUENCE_BONUS",			"+2 de [ICON_Cultura] Cultura em cada Museu de Arte ou Museu de Arqueologia."	),
	("pt_BR",	"LOC_CSE_CULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 de [ICON_Cultura] Cultura em cada Centro de Transmissão."					),
	("pt_BR",	"LOC_CSE_CULTURAL_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_CULTURAL} Cidade-Estado"									),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS",			"+4 de [ICON_GOLD] Ouro na sua [ICON_CAPITAL] Capital."					),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS",			"+4 de [ICON_GOLD] Ouro em cada Mercado ou Farol."						),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS_ALT",		"+4 de [ICON_GOLD] Ouro em cada Mercado."								),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS",			"+4 de [ICON_GOLD] Ouro em cada Banco ou Estaleiro."					),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS_ALT",		"+4 de [ICON_GOLD] Ouro em cada Banco."									),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS",			"+4 de [ICON_GOLD] Ouro em cada Bolsa de Valores ou Porto Marítimo."	),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS_ALT",		"+4 de [ICON_GOLD] Ouro em cada Bolsa de Valores."						),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_NAME",								"{LOC_CITY_STATES_TYPE_TRADE} Cidade-Estado"							),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_RELIGIOUS_TRAIT_SMALL_INFLUENCE_BONUS",		"+2 de [ICON_FAITH] Fé na sua [ICON_CAPITAL] Capital."		),
	("pt_BR",	"LOC_CSE_RELIGIOUS_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 de [ICON_FAITH] Fé em cada Santuário."					),
	("pt_BR",	"LOC_CSE_RELIGIOUS_TRAIT_LARGE_INFLUENCE_BONUS",		"+2 de [ICON_FAITH] Fé em cada Templo."						),
	("pt_BR",	"LOC_CSE_RELIGIOUS_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 de [ICON_FAITH] Fé em cada Local Sagrado."				),
	("pt_BR",	"LOC_CSE_RELIGIOUS_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_RELIGIOUS} Cidade-Estado"			),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_MILITARISTIC_TRAIT_SMALL_INFLUENCE_BONUS",		"+2 de [ICON_PRODUCTION] Produção para unidades na sua [ICON_CAPITAL] Capital."					),
	("pt_BR",	"LOC_CSE_MILITARISTIC_TRAIT_MEDIUM_INFLUENCE_BONUS",	"+2 de [ICON_PRODUCTION] Produção para unidades em cada cidade com uma Caserna ou Estábulo."	),
	("pt_BR",	"LOC_CSE_MILITARISTIC_TRAIT_LARGE_INFLUENCE_BONUS",		"+2 de [ICON_PRODUCTION] Produção para unidades em cada cidade com um Arsenal."					),
	("pt_BR",	"LOC_CSE_MILITARISTIC_TRAIT_LARGEST_INFLUENCE_BONUS",	"+2 de [ICON_PRODUCTION] Produção para unidades em cada cidade com uma Academia Militar."		),
	("pt_BR",	"LOC_CSE_MILITARISTIC_TRAIT_NAME",						"{LOC_CITY_STATES_TYPE_MILITARISTIC} Cidade-Estado"												),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_INDUSTRIAL_TRAIT_SMALL_INFLUENCE_BONUS",		"+2 de [ICON_PRODUCTION] Produção para distritos e edificações na sua [ICON_CAPITAL] Capital."		),
	("pt_BR",	"LOC_CSE_INDUSTRIAL_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 de [ICON_PRODUCTION] Produção para distritos e edificações cada cidade com uma Oficina."		),
	("pt_BR",	"LOC_CSE_INDUSTRIAL_TRAIT_LARGE_INFLUENCE_BONUS",		"+2 de [ICON_PRODUCTION] Produção para distritos e edificações em cada cidade com uma Fábrica."		),
	("pt_BR",	"LOC_CSE_INDUSTRIAL_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 de [ICON_PRODUCTION] Produção para distritos e edificações em cada cidade com uma Usina."		),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_AGRICULTURAL_TRAIT_SMALL_INFLUENCE_BONUS",			"+2 de [ICON_FOOD] Alimento na sua [ICON_CAPITAL] Capital."		),
	("pt_BR",	"LOC_CSE_AGRICULTURAL_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 de [ICON_FOOD] Alimento em cada Celeiro."					),
	("pt_BR",	"LOC_CSE_AGRICULTURAL_TRAIT_LARGE_INFLUENCE_BONUS",			"+2 de [ICON_FOOD] Alimento em cada Esgoto."					),
	("pt_BR",	"LOC_CSE_AGRICULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 de [ICON_FOOD] Alimento em cada Aqueduto."					),
	("pt_BR",	"LOC_CSE_AGRICULTURAL_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_CSE_AGRICULTURAL} Cidade-Estado"			),
...
-----------------------------------------------
	...
	("en_US",	"LOC_CSE_ENTERTAINMENT_TRAIT_SMALL_INFLUENCE_BONUS",		"+1 de [ICON_AMENITIES] Amenity in the [ICON_CAPITAL] Capital."	),
	("en_US",	"LOC_CSE_ENTERTAINMENT_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+1 de [ICON_AMENITIES] Amenity in every Arena."		),
	("en_US",	"LOC_CSE_ENTERTAINMENT_TRAIT_LARGE_INFLUENCE_BONUS",		"+1 de [ICON_AMENITIES] Amenity in every Zoo."	),
	("en_US",	"LOC_CSE_ENTERTAINMENT_TRAIT_LARGEST_INFLUENCE_BONUS",		"+1 de [ICON_AMENITIES] Amenity in every Stadium."	),
	...
	("pt_BR",	"LOC_CSE_ENTERTAINMENT_TRAIT_SMALL_INFLUENCE_BONUS",		"+1 de [ICON_AMENITIES] Serviço na sua [ICON_CAPITAL] Capital."	),
	("pt_BR",	"LOC_CSE_ENTERTAINMENT_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+1 de [ICON_AMENITIES] Serviço em cada Arena."		),
	("pt_BR",	"LOC_CSE_ENTERTAINMENT_TRAIT_LARGE_INFLUENCE_BONUS",		"+1 de [ICON_AMENITIES] Serviço em cada Zoológico."	),
	("pt_BR",	"LOC_CSE_ENTERTAINMENT_TRAIT_LARGEST_INFLUENCE_BONUS",		"+1 de [ICON_AMENITIES] Serviço em cada Estágio."	),
	("pt_BR",	"LOC_CSE_ENTERTAINMENT_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_CSE_ENTERTAINMENT} Cidade-Estado"	),
...
-----------------------------------------------
	...
	("en_US",	"LOC_CITY_STATES_TYPE_CSE_MARITIME",					"Marítima"	),
	("en_US",	"LOC_CSE_MARITIME_TRAIT_SMALL_INFLUENCE_BONUS",			"+1 de [ICON_FOOD] Alimento e +1 de [ICON_PRODUCTION] Produção na sua [ICON_CAPITAL] Capital."	),
	("en_US",	"LOC_CSE_MARITIME_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+1 de [ICON_Alimento] Alimento e +1 de [ICON_PRODUCTION] Produção em cada Farol."		),
	("en_US",	"LOC_CSE_MARITIME_TRAIT_LARGE_INFLUENCE_BONUS",			"+1 de [ICON_Alimento] Alimento e +1 de [ICON_PRODUCTION] Produção em cada Estaleiro."	),
	("en_US",	"LOC_CSE_MARITIME_TRAIT_LARGEST_INFLUENCE_BONUS",		"+1 de [ICON_Alimento] Alimento e +1 de [ICON_PRODUCTION] Produção em cada Porto Marítimo."	),
	("en_US",	"LOC_CSE_MARITIME_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_CSE_MARITIME} Cidade-Estado"	),
	("en_US",	"LOC_CSE_MARITIME_TRAIT_DESCRIPTION",					"{LOC_MINOR_CIV_SMALL_INFLUENCE_ENVOYS} {LOC_CSE_MARITIME_TRAIT_SMALL_INFLUENCE_BONUS}[NEWLINE]{LOC_MINOR_CIV_MEDIUM_INFLUENCE_ENVOYS} {LOC_CSE_MARITIME_TRAIT_MEDIUM_INFLUENCE_BONUS}[NEWLINE]{LOC_MINOR_CIV_LARGE_INFLUENCE_ENVOYS} {LOC_CSE_MARITIME_TRAIT_LARGE_INFLUENCE_BONUS}[NEWLINE]{LOC_MINOR_CIV_LARGEST_INFLUENCE_ENVOYS} {LOC_CSE_MARITIME_TRAIT_LARGEST_INFLUENCE_BONUS}"	),
	("en_US",	"LOC_PEDIA_CITYSTATES_PAGEGROUP_CSE_MARITIME_NAME",		"{LOC_CITY_STATES_TYPE_CSE_MARITIME}"	),
