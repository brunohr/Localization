...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_MARITIME_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+1 de [ICON_FOOD] Alimento e +1 de [ICON_PRODUCTION] Produção em cada Farol."		),
	("pt_BR",	"LOC_CSE_MARITIME_TRAIT_LARGE_INFLUENCE_BONUS",			"+1 de [ICON_FOOD] Alimento e +1 de [ICON_PRODUCTION] Produção em cada Estaleiro."	),
	("pt_BR",	"LOC_CSE_MARITIME_TRAIT_LARGEST_INFLUENCE_BONUS",		"+1 de [ICON_FOOD] Alimento e +1 de [ICON_PRODUCTION] Produção em cada Porto Marítimo."	),
