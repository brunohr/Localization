...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_CULTURAL_TRAIT_SMALL_INFLUENCE_BONUS",			"+2 de [ICON_CULTURE] Cultura na sua [ICON_CAPITAL] Capital."					),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CITY_STATES_TYPE_CSE_MARITIME",					"Marítima"	),
	("pt_BR",	"LOC_CSE_MARITIME_TRAIT_SMALL_INFLUENCE_BONUS",			"+1 de [ICON_FOOD] Alimento e +1 de [ICON_PRODUCTION] Produção na sua [ICON_CAPITAL] Capital."	),
	("pt_BR",	"LOC_CSE_MARITIME_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+1 de [ICON_Alimento] Alimento e +1 de [ICON_PRODUCTION] Produção em cada Farol."		),
	("pt_BR",	"LOC_CSE_MARITIME_TRAIT_LARGE_INFLUENCE_BONUS",			"+1 de [ICON_Alimento] Alimento e +1 de [ICON_PRODUCTION] Produção em cada Estaleiro."	),
	("pt_BR",	"LOC_CSE_MARITIME_TRAIT_LARGEST_INFLUENCE_BONUS",		"+1 de [ICON_Alimento] Alimento e +1 de [ICON_PRODUCTION] Produção em cada Porto Marítimo."	),
	("pt_BR",	"LOC_CSE_MARITIME_TRAIT_NAME",							"{LOC_CITY_STATES_TYPE_CSE_MARITIME} Cidade-Estado"	),
