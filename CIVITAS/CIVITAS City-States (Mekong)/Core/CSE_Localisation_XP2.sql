...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_CONSULAR_TRAIT_SMALL_INFLUENCE_BONUS_XP2",			"+2 de [ICON_FAVOR] Favor Diplomático na sua [ICON_CAPITAL] Capital."	),
	("pt_BR",	"LOC_CSE_CONSULAR_TRAIT_MEDIUM_INFLUENCE_BONUS_XP2",		"+2 de [ICON_FAVOR] Favor Diplomático em qualquer edificação de primeiro nível do Edifício Admnistrativo."		),
	("pt_BR",	"LOC_CSE_CONSULAR_TRAIT_LARGE_INFLUENCE_BONUS_XP2",			"+2 de [ICON_FAVOR] Favor Diplomático em qualquer edificação de segundo nível do Edifício Admnistrativo."	),
	("pt_BR",	"LOC_CSE_CONSULAR_TRAIT_LARGEST_INFLUENCE_BONUS_XP2",		"+2 de [ICON_FAVOR] Favor Diplomático em qualquer edificação de terceiro nível do Edifício Admnistrativo."		),

	("pt_BR",	"LOC_CSE_CONSULAR_TRAIT_NAME",								"{LOC_CITY_STATES_TYPE_CSE_CONSULAR} Cidade-Estado"	),
	("pt_BR",	"LOC_CSE_CONSULAR_TRAIT_DESCRIPTION_XP2",					"{LOC_MINOR_CIV_SMALL_INFLUENCE_ENVOYS} {LOC_CSE_CONSULAR_TRAIT_SMALL_INFLUENCE_BONUS_XP2}[NEWLINE]{LOC_MINOR_CIV_MEDIUM_INFLUENCE_ENVOYS} {LOC_CSE_CONSULAR_TRAIT_MEDIUM_INFLUENCE_BONUS_XP2}[NEWLINE]{LOC_MINOR_CIV_LARGE_INFLUENCE_ENVOYS} {LOC_CSE_CONSULAR_TRAIT_LARGE_INFLUENCE_BONUS_XP2}[NEWLINE]{LOC_MINOR_CIV_LARGEST_INFLUENCE_ENVOYS} {LOC_CSE_CONSULAR_TRAIT_LARGEST_INFLUENCE_BONUS_XP2}"	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_BUILDING_ORSZAGHAZ_DESCRIPTION",					"+1 de [ICON_FAVOR] Favor Diplomático por turno de Cidade-Estados aliadas.[NEWLINE][NEWLINE]Deve ser construído em um Rio."	);
