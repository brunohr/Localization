...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_AGRICULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS",	"+2 de [ICON_FOOD] Alimento em cada Mercadão and Shopping."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_CONSULAR_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 de Lealdade em cada cidade."		),
