/*
	...
	cachaco: i translated only enough for the vlad III mod, so civilopedia and mod support are still in english 
*/
...
-----------------------------------------------
	...
	"Recebe +100% de bônus de Flanco e Suporte durante uma Emergência, e Emergências bem-sucedidadas te recompesam com uma Tecnologia e um Cívico grátis. Campos base de [ICON_PRODUCTION] Produção base de edificações de Acampamento são dobrados quando em guerra contra outra civilização."	),
